...
import 'package:frontend/core/constants/app_timeouts.dart';
...
Dio dio(Ref ref) {
  final dio = Dio(
    BaseOptions(
      ...
      connectTimeout: AppTimeouts.networkRequest,
      receiveTimeout: AppTimeouts.networkRequest,
      sendTimeout: AppTimeouts.networkRequest,
